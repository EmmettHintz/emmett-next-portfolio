...
const DarkModeToggle: React.FC = () => {
  ...
  return (
    <button
      className="fixed right-4 top-4 h-12 w-12 rounded border border-gray-800 bg-white dark:border-white dark:bg-gray-800 flex items-center justify-center sm:right-6 sm:top-6 sm:h-16 sm:w-16"
