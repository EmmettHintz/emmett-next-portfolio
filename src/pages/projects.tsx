...
const projects = () => {
  return (
    <div className="h-screen w-full bg-gray-800 px-20">
      <div>
        <NavBar />
      </div>
      ...
      <div className="grid h-auto grid-cols-2 py-8">
        ...
        <div className="flex-cols w-[100%] justify-center text-center ">
          <p className="py-4 text-4xl font-bold text-sky-400">
            Present project:
          </p>
          <a
            href="www.litlocator.com"
            className=" text-3xl  font-semibold text-rose-400 transition-all duration-300 hover:text-rose-500 hover:underline"
          >
            litlocator
          </a>
        </div>
